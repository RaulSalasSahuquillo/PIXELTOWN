...
class _TetrisExit(Exception):
    """Raised to exit the Tetris game cleanly when running inside PIXELTOWN."""
    def __init__(self, scene="minijuegos"):
        self.scene = scene
